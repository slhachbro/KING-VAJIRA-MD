...
async(Suhail, citel, text) => {
  ...
  try{
    ...
    let buttonMessage = { video: fs.readFileSync(randomName),mimetype: 'video/mp4',caption: "  _✅ඔබ ඉල්ලූ වීඩියෝව✅_\n\n📌Title : " + i.title + "\n\n🔰Url : " + i.url +"\n\n🗺️Description : " + i.timestamp +"\n\n👥Views : "+i.views +"\n\n📥Uploaded : " +i.ago +"\n\n👤Author : "+i.author.name+"\n\n" + Config.caption ,height: 496, width: 640,}
...
async(Suhail, citel, text) => {
  ...
  try {
    ...
    await citel.send(`_🎶ඔබේ ගීතය භාගත කරමින් පවති ${info.title}?_`);
