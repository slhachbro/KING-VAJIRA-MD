...
-----------------------------------------------------------------------------------------------------------
       ...
       ᴡ ʜ ᴀ ᴛ ꜱ ᴀ ᴘ ᴘ    ʙ ᴏ ᴛ    ᴍ ᴜ ʟ ᴛ ɪ - ᴅ ᴇ ᴠ ɪ ᴄ ᴇ
            V  1.0.1
         **/
...
smd({
   ...
   if (!text) return citel.reply("*need some words!*")
            let name1 = text.split("|")[0]
            let name2 = text.split("|")[1] || `1`
            citel.reply(`*Sending ${name2} image(s) in chat*`)
            let nn = name2
            for (let i = 0; i < nn; i++) {
                ...
                images = n[Math.floor(Math.random() * n.length)].url;
                    let buttonMessage = {
                        ...
                        caption: `ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ᴠᴀᴊɪʀᴀ-ᴍᴅ ʙᴏᴛ`,
                        headerType: 4,
                    };
